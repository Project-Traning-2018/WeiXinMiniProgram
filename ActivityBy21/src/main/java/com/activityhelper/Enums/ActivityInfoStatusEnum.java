...
public enum ActivityInfoStatusEnum {
    ...
    ACTIVITY_FindBYSTR_SUCCESS( 19, "活动搜索成功" ),
    ACTIVITY_STATUS_VALID( 20, "活动有效" ),
    ACTIVITY_STATUS_INVALID( 21, "活动无效" ),
    ACTIVITY_STATUS_DELETE( 22, "活动已删除" ),
    ACTIVITY_PARTICIPATEINFO_SUCCESS( 23, "活动报名信息获取成功" ),
    ACTIVITY_BACK_STATUS_DELETE( 24, "后台删除活动成功" ),
    ACTIVITY_BACK_STATUS_List( 25, "后台获取活动列表成功" ),
    ACTIVITY_BACK_STATUS_SEARCH( 26, "后台搜寻活动成功" ),
    ACTIVITY_BACK_STATUS_GETONE( 27, "后台获取一条活动信息成功" ),
    ;
